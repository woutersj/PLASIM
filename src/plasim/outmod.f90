...
!     planet properties to the postprocessor "burn"
      ...
      subroutine test_nc(kunit,pf,kcode,klev)
          ...
          call nc_check( nf90_create(FILE_NAME, NF90_CLOBBER, ncid) )

          ! Define the dimensions. NetCDF will hand back an ID for each.
          call nc_check( nf90_def_dim(ncid, "x", NX, x_dimid) )
          call nc_check( nf90_def_dim(ncid, "y", NY, y_dimid) )
          ...
          call nc_check( nf90_def_var(ncid, "data", NF90_INT, dimids, varid) )
          ...
          call nc_check( nf90_put_var(ncid, varid, data_out) )
